...
RSpec.describe Post, type: :model do
  ...
  it 'updates a posts comments correctly' do
    ...
    post = user.posts.create(title: 'Post1', text: 'Using the Web to Avenger for the world! Yeeh', likes_counter: 0, comments_counter: 0)
    post.comments.create(author_id: user.id, post_id: post.id, text: 'Hi Amkam WebAvenger!')
